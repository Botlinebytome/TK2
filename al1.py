...
cl = LINETCR.LINE()
cl.login(token="EsIbwbvmAA0oFH7NZhN4.u1vf2RPtXBahO8RWE8q+ja.w79Sg3Q5yHXN7D7jNlBvvnQqSnreXJ0iy4ZJXYrwCn8=")
cl.loginResult()
...
Bots = [mid]
admsa = "u535545daba53c5b007a3caf07bc43f24"
admin = "u535545daba53c5b007a3caf07bc43f24"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u7ae7554b616cef5fd20d034879c9b082":
                    if "join:" in msg.text:
                    ...
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                 ...
                                 #   'STKVER' : '1'}
                                  ...
                                  msg.contentType = 7    
                                  msg.text = None
                                  msg.contentMetadata = {'STKID': '30315671',
                                    'STKPKGID': '3026249',
                                    'STKVER': '1'}
                                    #'STKVER': '1'}
