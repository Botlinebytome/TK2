...
cl = LINETCR.LINE()
cl.login(token="Epqa3AExeXVUPYGpqz3b.KJ+kpCKh4eDxkTjCjphsMW.uhxgBlcEQe4AfQvYzlt0kmlQ7VFv0JSFd89NtXk0C88=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpfiX4iNMizhSBqj9Sl4.FkKTJEGYLFrcnMONGBi8va.3rgBp465Vb3WDJd5WJkrxE+zZ9ToOvBE664PIg6PTgE=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EpDv8zULxhKOvjElSnR1.5n/caDlMqzdwvaHQL1twuq.iqVQ/UJXEbmzF6NRaKN4CpiLE8hZLHDOzlTAp9Y9de4=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="Ep9lGT1xWATBcCjdo4k7.3gTnYvMrJE/LXLsLn3lbDW.Ro2udH0OED4nEKW9If37cQywuGaNRtJC4G6CGWof894=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="Epc172tWAxtUfmadfq1f.8LH+r2ophcKANLp0TlT3NW.d8hwCoM1qGHE+phfJHCRfdhgcl2aZX3yvXtq8H5fILI=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Epf129ibqiwdU8Lhkh96.ib9KHw9w6fwiz11CNtgLXG.3SfGiiUO3T91eZVBW3XmkUUs8MWncQSwJ25akDiyNKw=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="Epot6tajNX3RdVRHUBUc.OP/zuf4NFpocZMYDVMFBFa.+cifYKMaTEdLPk+8h5eU5/1Moqgpgxm221LZV+OGQCE=")
ki6.loginResult()
...
admsa = "u923fca3dc907e047572ad25c24f1d29b"
...
wait = {
    ...
    "comment7":"Auto Like By Alvian putra",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if op.type == 7: # <-- elif atau if tergantung posisinya di awal apa ditengah
...
#--------------------------------------------------------
            if op.param3 in ki2mid:
		if op.param2 in mid:
		    kki2.acceptGroupInvitation(op.param1)
            if op.param3 in ki2mid:
		if op.param2 in kimid:
		    ki2.acceptGroupInvitation(op.param1)
            if op.param3 in ki2mid:
