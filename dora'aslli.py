...
cl = LINETCR.LINE()
cl.login(token="EoRCUEE5SthlhTC3yKba.PAtiXEanCQJK7icVutWHIG.hEwYr3iXdlTz8sZOtinTSMlEYvS9SjvB+GlocT7omFg=")
cl.loginResult()
...
kk = LINETCR.LINE()
kk.login(token="EnFKIaPrx97gfOAkuRtd.BbiXae1hQNxBW2egVFPFZq.CaYQW8SquBDaCHcOflo6mFMT0lGGQ28C")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EnkFGmLzKHjs3iTlBhy4.n4mGXGu9BQcT1pd8bIiRTa.YCi4y260EGIq1M/+xb3KGi6rv+pL5kG2Kea2kTxihto=")
kc.loginResult()

kb = LINETCR.LINE()
kb.login(token="En1x0U8N7egHwqJMjoz7.S2buvWa/ybKspv/ol2PR9W.NoDiTpPkC/JvKijnmwYX3xvcBTmcyOfub6a2S1os1uY=")
kb.loginResult()

kd = LINETCR.LINE()
kd.login(token="EniHjEpTwLyQpaPU1u43.AcPOUa9oo8qTw0R6Snc5uW.7ff9Gf0wtuiZ+AT6A6WV2w6ssSuLlrQCUbMmu/nvliU=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="En60qXYAyNSpWokzftDb.IXKXK6LFfrRLlynpkbC8oW.7wXwZNzgUxCCDqc1/onkUWqiyHXjzWQh5AxzU/ktPP8=")
ke.loginResult()

kg = LINETCR.LINE()
kg.login(token="EnCvdOFHOd3WnuUvGdp5.NFGDbF6wLvchxWolldv/Lq.U7d4B8E4MrnZtE4y+F7iV4r0ykOUJ6KmzhUn+gwa74k=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="EnnclXojnGx7MTd5Mfxd.3OW3EdxawiI/Y43HJmwQlq.q2KfTek0lIAUhGh5OoMUfwy7ipwr5SVPbixEMp+g3O8=")
kh.loginResult()

sw = LINETCR.LINE()
sw.login(token="EnLugWjWDgnDt29sW6Jd.cs0NY2cddDk6BMKCVLy7xq.e76l1XEfiwxChnBtavpVPt5Dr8aHiaeK5LbCiM7R6es=")
sw.loginResult()
...
helpMessage ="""
╔══════════════
╠ 卐✮Ginfo 「View group info」
╠ 卐✮Bot cancel 「Cancel all pending」
╠ 卐✮Say 「Text」
╠ 卐✮ Gn: 「Name group」
╠ 卐✮ Mymid 「Cek your mid」
╠ 卐✮Welcome on
╠ 卐✮Welcome off
╠ 卐✮ Lurkers
╠ 卐✮View
...
╠ 🦂❧❥Say 「Text」
╠ 🦂❧❥TD in 「All bot join」
╠ 🦂❧❥TD out 「All bot leave」
╠ 🦂❧❥TD copy 「@」
╠ 🦂❧❥TD kembali 「@」
╠ 🦂❧❥TD kick 「Mid」
╠ 🦂❧❥TD invite 「Mid」
╠ 🦂❧❥TD setting 「View bot setting」
╠ 🦂❧❥TD bot 「Cek all bots」
...
kantongajaibMessage ="""
K̝̒ͧa̷͖ͮn̨t͚̥̅o̅̓n̢ͦ̆͢g̤̪̉ ̴̶̪̠a̗͕̅̕͝j̷̄a͏i̘͘b̆͢
̨͐̅
❂☆➣  Checkig
❂☆➣  Memlist
❂☆➣  Searchid:
...
admin = ["ub76a0153a283da9a1443dfb043181335","u092d27cb60830dd2ba6e691cbe563b5d","ube597dd17603406a6b278bc62cc5fdcf"]
staff = ["ub76a0153a283da9a1443dfb043181335","u092d27cb60830dd2ba6e691cbe563b5d","ube597dd17603406a6b278bc62cc5fdcf"]
owner = ["ub76a0153a283da9a1443dfb043181335","u092d27cb60830dd2ba6e691cbe563b5d","ube597dd17603406a6b278bc62cc5fdcf"]
adminMID = 'ub76a0153a283da9a1443dfb043181335','u092d27cb60830dd2ba6e691cbe563b5d','ube597dd17603406a6b278bc62cc5fdcf'
wait ={ 
    'contact':False,
    'autoJoin':True,
