...
cl = LINETCR.LINE()
cl.login(token="ErO8CooXHhmMKt1vtcZ0.Ms8E/+B4HzOoKu6F09UEya.aKIqLt3snQy85EayRjvgtK89Nh29W+FG+kZszH3O4LM=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Erdi3rdhJQRGF8zv8Gif.6ea+QdJ3J1UQCzZOuPyttW.R0wvnK+W7XS3BdupqCLz61UeyUFuaXatTZgUbeOcxAM=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="ErlyCOfgU9MfbNJVvwC4.M+LMS9irp6MqC5LZghHV1a.KIvb29iQ/dizXjn5lqFS8RzGYGrASa41w6Jsc13C5N4=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="ErQQW2NOA79LmWcSleE7.1gWcs/OnkQSJobSO9md6PW.+lYhQgJoMnutLgIpNmLt6Z0S3c35odjd5dvboxeWQyY=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="Ermlo4YyhSOKmhj8pcFa.caLF+N26IHKE2vwTbDKakG.bypzBHc5zehnXG6268p6Zut6pl3yNzkZjX2rCHsyNP4=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="ErftwTWW90DW9qmbMWxd.UvStj/WeZKEjQw/UcyMNhq.ZSJDkhk2qYZwD7wx0Y0Czy7P3Q4Jmcc7evL5B0qYXsQ=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="Erm61XArujuSzOoVPbN2.+hqn4OePx2agp7gz+COSCG.hHmkMI9jbYKM2aEE+GmWF5+pHU6AX5N0mZNpRglS68Q=")
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token="ErpnRDlodgHqgqqhn4af.mUMmpSnGHJU81KTm+ANUxW.6LzgyboxlKl6R9i5fs9QmRXhwjhCoBIx6znLErD0a+s=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="ErXofS425yLrnlsQCNW1.hEXphPQ3KqbztOlCAheJeq.JjT+1uhaapF6VaHqGhUfpTMxfMwk+gP9veWHzvbvh8A=")
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token="Erlz3KhHVny66QqDTha0.tcrGtI8xmHn5F1Gh4T700a.1iVIVK3GBMMwlGAy6zdYKlHEx94mn/NoGzqKh+B5DIg=")
kj.loginResult()

kl = LINETCR.LINE()
kl.login(token="ErTGmvuKcQxuJWeyup4b.zItpo81d5DG2GYR8ZqjToW.cctQSv84cVShViCnEGFzUNbAaM+zIWcYfmtLlxASIQE=")
kl.loginResult()
...
[Link off]
[Link on]
[Cbroadcast「text broadcast」] 
[Gbroadcast「text broadcast」] 
[Gurl]
[Tagall]
[R1-2-3 Tag]
[Protect「on/off」]
...
[Bye]
[R1-2-3 bye]
[R1-R2-R3 rename:「Name」]
[R1-R2-R3 tl:「post」]
[R1-R2-R3 gn:「Group Name」]
[R1-2-3 Link on]
[R1-2-3 Link off]
[R1-R2-R3 gurl:「Group id」]
[Kill]
[Kill ban]
[Mk:「@」]
[Cleanse]
...
admin=["u992f1efbf6f8859a0e914e9fd3db9e60"]
wait = {
    'contact':False,
    'autoJoin':False,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me MY NAME IS daeng",
    "lang":"JP",
    "comment":"Thanks for add me MY NAME IS daeng",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#===========================================
        ...
        if op.type == 25:
            ...
            elif msg.text in ["Bot cancel","Rcancel","Botcancel"]:
                if msg.toType == 2:
            ...
            elif "R1 say " in msg.text:
				saytxt = msg.text.replace("R1 say ","")
				ki.sendText(msg.to,(saytxt))
            elif "R2 say " in msg.text:
				saytext = msg.text.replace("R2 say ","")
				kk.sendText(msg.to,(saytext))
            elif msg.text in ["R say hi"]:
...
#======================================
            ...
            elif "R1 tl: " in msg.text:
                tl_text = msg.text.replace("R1 tl: ","")
                ki.sendText(msg.to,"line://home/post?userMid="+mid+"&postId="+ki.new_post(tl_text)["result"]["post"]["postInfo"]["postId"])
            elif "R2 tl: " in msg.text:
                tl_text = msg.text.replace("R2 tl: ","")
            ...
            elif "R1 rename: " in msg.text:
                string = msg.text.replace("R1 rename: ","")
                if len(string.decode('utf-8')) <= 20:
                    profile_B = ki.getProfile()
                    profile_B.displayName = string
                    ki.updateProfile(profile_B)
                    ki.sendText(msg.to,"Name " + string + " done")
            elif "R2 rename: " in msg.text:
                string = msg.text.replace("R2 rename: ","")
                if len(string.decode('utf-8')) <= 20:
...
#========================================
            ...
            elif msg.text in ["R1 rgroups","R1 rgroup"]:
            ...
            elif msg.text in ["R2 rgroups","R2 rgroup"]:
...
#===========================================
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Not for use less than group")
            elif "R1 gurl: " in msg.text:
                if msg.toType == 2:
                    gid = msg.text.replace("R1 gurl: ","")
                    x = ki.getGroup(gid)
                    if x.preventJoinByTicket == True:
                        x.preventJoinByTicket = False
                        ki.updateGroup(x)
                    ...
                    ki.sendText(msg.to,"Not for use less than group")
            elif "R2 gurl: " in msg.text:
                if msg.toType == 2:
                    gid = msg.text.replace("R2 gurl: ","")
                    x = kk.getGroup(gid)
                    if x.preventJoinByTicket == True:
                        x.preventJoinByTicket = False
                        kk.updateGroup(x)
...
#========================================
					...
					kf.updateGroup(G)
            elif msg.text in ["R1 join","R1 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
            ...
            elif msg.text in ["R2 join","R2 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
            ...
            elif msg.text in ["R3 join","R3 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
            ...
            elif msg.text in ["R4 join","R4 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
            ...
            elif msg.text in ["R5 join","R5 in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
				...
				for i in gid:
					...
					kj.leaveGroup(i)
				if wait["lang"] == "JP":
					random.choice(KAC).sendText(msg.to,"sayonara")
				else:
					random.choice(KAC).sendText(msg.to,"He declined all invitations")
            elif msg.text in ["_","bye all"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     ...
                     pass
            elif msg.text in ["R1 @bye","R1 pulang","R1 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     ki.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["R2 @bye","R2 pulang","R2 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kk.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["R3 @bye","R3 pulang","R3 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kc.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["R4 @bye","R4 pulang","R4 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kd.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["R5 @bye","R5 pulang","R5 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     ke.leaveGroup(msg.to)
