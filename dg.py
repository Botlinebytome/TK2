...
cl = LINETCR.LINE()
cl.login(token="EqRu8ojjHMQ6uy0NPhp8.1G3eskfEbGhcs89M+Del6a.CPdIaQ84+lPSOxah/yH50U32RHAYpnMPR6VdlAk4ST0=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Eqlxm3YVvEqkMTKV4fe8.T3272TMXhUqfcOff0BePsa.L2OTM05RqzXmdTkIDqA8G6AoyYPc2ME0t2DVjXwjl9k=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EqV88Oe231LeF99nlot1.4/DbREZDNa+eY9NQjQHFWq.TLXAc0wQk+YsMQ3i589PHP+5fY/ZLfIayS2jBgrtAoQ=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EqgocCeITnljxZ28ddFd.uYrLp4pWJ4OvzHubyBYLNq.INypdhe5npy7V1+9SiDkRM7J6EHCACCAEtQKcHWZnvc=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EqffOGXEro8ypgB2Gchc.IMPYkmxirjoPmv5qMwZUBa.8m+cWn0Kh1dCwPjKWoRtfWbmnxb+DKKShWGeVwy6bGo=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EqNvfqYj17jsBbiz4B82.Zv+zpqfxVzXS6JD7JABYaG.3+CfzLU6cZTMxi8h8+bjFLYONIZrVX+9SNl1CzAyKvE=")
ki5.loginResult()
...
ki5mid = ki4.getProfile().mid
Bots = ["ud60dc448a15e0601c24bcf66fdd10be8","ub77dbbdad9b11ee4050a8145d1b12948","ue3e741adecdd9c0fc4cbd9ea26a85fc1","u5324653f83f08f8a1566150161bca59d","u8a6a7228c5c84493a9315e50996cee6c","ucd5fd93d0157bd9c6cea377b8da6f202"]
admsa = "ud60dc448a15e0601c24bcf66fdd10be8","ub77dbbdad9b11ee4050a8145d1b12948","ue3e741adecdd9c0fc4cbd9ea26a85fc1","u5324653f83f08f8a1566150161bca59d","u8a6a7228c5c84493a9315e50996cee6c","ucd5fd93d0157bd9c6cea377b8da6f202"
admin = "ud60dc448a15e0601c24bcf66fdd10be8"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ud60dc448a15e0601c24bcf66fdd10be8":
                    if "join:" in msg.text:
                    ...
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                 ...
                                 #   'STKVER' : '1'}
                                  ...
                                  msg.contentType = 7    
                                  msg.text = None
                                  msg.contentMetadata = {'STKID': '18423382',
                                    'STKPKGID': '1509202',
                                    'STKVER': '1'}
                                    #'STKVER': '1'}
...
#---------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                if wait["detectMention"] == True: md+="║◉⊱ ᴀᴜᴛᴏ ʀᴇsᴘᴏɴ → ᴏғғ\n║◉⊱ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴀʙᴜ \n╚════════════════ \nPᴏᴡᴇʀᴇᴅ ʙʏ: \n    ҉̶̶̘̟̼̉̈́͐͋͌̊D҉ͩ͂҉̘̟̼̉̈́͐͋͌̊҉̶̶̘̟̼̉̈́͐͋͌̊Δ̶҉̶̶̘̟̼̉̈́͐͋͌̊҉̘̉̈́͐͋͌̊҉̶̘̟̼̉̈́͐͋͌̊҉̘̟̉̈́͐͋͌̊E҉̶̶̘̟̼̉̈́͐͋͌̊҉̘̉̈́͐͋͌̊҉̶̘̟̼̉̈́͐͋͌̊҉̘̟̉̈́͐͋͌̊N҉ͩ͂҉̘̟̼̉̈́͐͋͌̊҉̶̶̘̟̼̉̈́͐͋͌̊҉̘̟̉̈́͐͋͌̊G҉ͩ͂҉̘̟̼̉̈́͐͋͌̊҉̶̶̘̟̼̉̈́͐͋͌̊҉ͩ͂҉̘̟̼̉̈́͐͋͌̊҉̶̶̘̟̼̉̈́͐͋͌̊ྈT҉̶̶̘̟̼̉̈́͐͋͌̊҉̘̉̈́͐͋͌̊҉̶̘̟̼̉̈́͐͋͌̊҉̘̟̉̈́͐͋͌̊E҉̶̘̟̼̉̈́͐͋͌̊҉̶̶̘̟̼̉̈́͐͋͌̊A҉ͩ͂҉̘̟̼̉̈́͐͋͌̊҉̶̶̘̟̼̉̈́͐͋͌̊҉̶̶̶̘̟̼̉̈́͐͋͌̊҉ͩ͂҉̘̟̼̉̈́͐͋͌̊҉̶̶̘̟̼̉̈́͐͋͌̊M҉̶̘̟̼̉̈́͐͋͌̊҉ͩ͂ྈB҉̶̶̘̟̼̉̈́͐͋͌̊Ω҉̶̘̟̼̉̈́͐͋͌̊T҉̶̘̟̼̉̈́͐͋͌̊S҉̶̘̟̼̉̈́͐͋͌̊ "
        ...
        if op.type == 19:
          ...
          if op.param2 in admin:
            ...
            try:
              ...
              random.choice(KAC).sendMessage(c)
              random.choice(KAC).leaveGroup(op.param1)
              G.preventJoinByTicket = True
              cl.updateGroup(G)
              wait["blacklist"][op.param2] = True
            except:
