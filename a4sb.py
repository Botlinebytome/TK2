...
cl = LINETCR.LINE()
cl.login(token="EqWWR26IWDEYziGGxgO3.63YbUrCDYj3vLySp+2pqyW.fRXaVuf+wvFutlv3q7F1+K2HQ5EApv4VEdMyFeD4/2k=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Eqeu91sLfWqxBbQUpEOd.rOvkE4wdrWDgUw5BqKIsFq.G/S2vnwSS5v4IaVv3U70xF+XSUV80wKycZhfRCTzpGk=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EqxkUtWuFOBszhUhE2p2.khD9bQ+ti22ABiO7LNMD4G.QlkMxvBg0CuUPVfX13SuipGFOPZ6d1lg/n8Qi76Xs+M=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EqD5tzNzx0KtmAQLbjWa.JRYPnJyEZsTPDFdLKpnBYG.LpJ0dn76dpoBvVAFGoE/p86FruMF4fuqu48IrT7HdxA=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EqaMsxY5y2nN7ZDsu0Te.xKIo3FV/N0Ss6auVtJl0BG.KFQ7IQ/A0iR2tHjxaf1EpkpT8X9ra8tqxwRa4BkcvgY=")
ki4.loginResult()
...
admsa = "ueb7c81b9171dc89dd5958b0fff63d063"
admin = "ueb7c81b9171dc89dd5958b0fff63d063"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ueb7c81b9171dc89dd5958b0fff63d063":
                    if "join:" in msg.text:
                    ...
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                 ...
                                 #   'STKVER' : '1'}
                                  ...
                                  msg.contentType = 7    
                                  msg.text = None
                                  msg.contentMetadata = {'STKID': '32404',
                                    'STKPKGID': '1699',
                                    'STKVER': '1'}
                                    #'STKVER': '1'}
