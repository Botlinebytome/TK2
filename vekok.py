...
cl = LINETCR.LINE()
cl.login(token="EqWELJzXpje6XBw7it7f.B31KkagB22fnrTy+bKe2xW.O0ZI3TGvjSt27dq/xJeSeZhPfyq6NbyLeVDexQPqcXQ=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Eq5pOIqG27liZfqeX8Ef.Ero/VJ5xOw2iqh2ALqDhxW.7zfRDJqF8KV8xmTu/Z9rORILRT+yzIhgvj7MBIfhAgA=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EqGtr7iuNH1XoME7mxt7.w+AV+cZBQxv+/U8IdyWJPW.V4foUOpi9WZE2fi9M4P8RWQWlQY1Fvqbzx5ZyBMyunQ=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="Eq5zJk86zv5SrLbIH51b.bBSybzutQaw57wJHt8MgwW.Q3FtPd2fwk2TaFTThnrYIlwHluZLb8UcnQXVl6QwKy8=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EqyrCnvDGe0MsJoHp9Y0.E9yPV9pP2ziYVrmEOHKaKa.d2TqLmqIbEAVEoIitnWN9lzrL+4N6YX3b4vlD4Sf4mQ=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EqnmZymkllefeDez2Rv2.DAeLL0vidtYP0vcK+pNB4G.L20Kkv97PQcOWbs0ZCKsmrc/exb0EOy9vk3+IPXgwKI=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EqqYGGSuFD7wT3gSut8b.biJGMKgHo5xvBlWE6Q6bYW.sQ0z61Yex+zd+AfM4kIF9ET0GnJOM5cIu3VN4mKYa6U=")
ki6.loginResult()

#ki7 = LINETCR.LINE() #ghost kicker
#ki7.login(token="EpTgvaEbZhbVBsDQKa8c.OP/zuf4NFpocZMYDVMFBFa.PiB9ZvjcJErQzp9lvttB0XN3gPHoxrRfiHmL5YLrbnE=")
#ki7.loginResult()
...
admin = []
targets = []
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,"u12e5f04e079c43903a5a39ebe55e6a1f"]
creator = "u6f7d6428019bdb614d46d63f0641365f"
admsa = "u6f7d6428019bdb614d46d63f0641365f"
admin = "u6f7d6428019bdb614d46d63f0641365f"
whitelist=[""]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    "lang":"JP",
    "comment1":"Auto Like By TEAM BOT HOLLOW",
    "comment2":"Auto Like By TEAM BOT HOLLOW",
    "comment3":"Auto Like By TEAM BOT HOLLOW",
    "comment4":"Auto Like By TEAM BOT HOLLOW",
    "comment5":"Auto Like By TEAM BOT HOLLOW",
    "comment6":"Auto Like By TEAM BOT HOLLOW",
    "comment7":"Auto Like By TEAM BOT HOLLOW",
    "commentOn":True,
    "likeOn":True,
    "commentBlack":{},
    "wblack":False,
...
#jam = datetime.utcnow() + timedelta(hours = 7)
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u6f7d6428019bdb614d46d63f0641365f":
                    if "join:" in msg.text:
                    ...
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                 ...
                                 #   'STKVER' : '1'}
                                  ...
                                  msg.contentType = 7    
                                  msg.text = None
                                  msg.contentMetadata = {'STKID': '16844048',
                                    'STKPKGID': '8670',
                                    'STKVER': '1'}
                                    #'STKVER': '1'}
                 ...
                 if wait["tag"] == True:
                    ...
                    for mention in mentionees:
                        if mention['M'] in Bots:
                            ...
                            msg.contentType = 0
                            balas = "@" +xname+ "   Apasih tag-tag? Penting PC aja.","@" +xname+ "   fans aku yaa?","@" +xname+ "   Nggak Usah Tag-Tag! Kalo Ada Perlu PC Aja!","@" +xname+ "\nKenapa Tag saya?","@" +xname+ "\nSokap deh ngetag.","@" +xname+ "\napaan ngetag?"
...
#-----------------------[Add Staff Section]------------------------
                ...
                if msg.from_ in admin:
                   ...
                   x+="╠️ ʙᴏᴛ ᴄʀᴇᴀᴛᴏʀ: alvian_putra777\n"
            ...
            if wait["linkprotect"] == True:
             # if wait["protect"] == False	
                if op.param2 not in Bots:
                    ...
                    time.sleep(0.01)
                    random.choice(KAC).updateGroup(G)
                    ki6.kickoutFromGroup(op.param1,[op.param3])
                    ki6.updateGroup(G)
                    ki6.leaveGroup(op.param1)
                    wait["blacklist"][op.param2] = True
        #------Open QR Kick finish-----#
...
#--------------------------------------------------------------
		...
		ki2.removeAllMessages()
		ki3.removeAllMessages()
		ki4.removeAllMessages()
		ki5.removeAllMessages()
		ki6.removeAllMessages()
		        #------Cek Sider-----#
        if op.type == 55:
            try:
