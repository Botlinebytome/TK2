...
cl = LINETCR.LINE()
cl.login(token="EqXwaicfNzW9Y1r9u9r1.HrDcTSmNiuYxGCeCs6wryq.SwK0qoQ7FZvKHoV3Yg/KijrcA6owTXIut+ByQYKqQXg=")
cl.loginResult()
...
admin = []
targets = []
Bots = [mid,"u851742b6c327214c9781c11c4ba59161"]
creator = "u851742b6c327214c9781c11c4ba59161"
admsa = "u851742b6c327214c9781c11c4ba59161"
admin = "u851742b6c327214c9781c11c4ba59161"
whitelist=[""]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u027f8cab400fde18931a665b301ac785":
                    if "join:" in msg.text:
