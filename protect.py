...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token="Eq8q84sl1sFhHtZukixe.zcYv/wHhqDEhtYana0iD+G.lmIePuRIhNmfG9dg8wFTzj0OSvJ8YKpgibhUpnEAeSY=")
cl.loginResult()
#vidia
kt = LINETCR.LINE()
kt.login(token="EqprlSAHrIZCAKefBHH4.AnP8pEBLue2dT0XPSREq5a.0/VV/RJVNZc28u5mrF83L+/07ro6YPfzrz6jaSeLQt4=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
ks.login(token="EqEvnDQS2y55RPYMqCSc.IMPYkmxirjoPmv5qMwZUBa.P0BMJjL4l8DgHFkS87WOf4RQrsFyyYtd5ycWGylTYlE=")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE()
ki.login(token="EqIRUeWEnrWq3hEMAYH2.Zv+zpqfxVzXS6JD7JABYaG.kF4onX/iUjUqWPKdt4kFXhaXakqYupS1QE1kJQhAk8k=")
ki.loginResult()
#fawn
kk = LINETCR.LINE()
kk.login(token="Eq6NAmouSSbn7BGHen4e.kh9ezrk05RlMgLEp+MtnZG.vqYEClpVvPTaThfCjHgs4KoI14pR+haPbTA4MYkZ+Is=")
kk.loginResult()
#iridessa
kc = LINETCR.LINE()
kc.login(token="EqABUk6s2VrcRGCXj9Le.Hax8R0iJO9wMXnZSH2MuFG.iNVlt/efDvl15VVQIg3UUO3mzMDk6z9VF9dVvsF5Ae4=")
kc.loginResult()

#kicker ghost
kl = LINETCR.LINE()
kl.login(token="EqhXr7h4cj2MgYEbFgsd.XFZ5DcYPFiWjGZsmhYktJq.FnOSqCfCMbLWmK05zz+VQdnsRAVlyxmrs1VUOHRazfs=")
kl.loginResult()
...
admin = ["u3cebd33aaf155f09c736079d03b40757","u923fca3dc907e047572ad25c24f1d29b"]
owner = ["u3cebd33aaf155f09c736079d03b40757","u923fca3dc907e047572ad25c24f1d29b"]
wait = {
    'contact':False,
    'autoJoin':True,
                ...
                if targets ==[]:
                        ...
                        for target in targets:
                                try:
                                        ...
                                        kl.sendText(msg.t,"Jangan baperrr ya....")
                                        kl.sendText(msg.to,"Baper hapus akun aja...!!")
                                        kl.leaveGroup(msg.to)
                                        gs = cl.getGroup(msg.to)
...
#========================================
              ...
              if msg.from_ in admin:
                ginfo = cl.getGroup(msg.to)
                cl.sendText(msg.to,"Welcome to zona " + str(ginfo.name))
                cl.sendText(msg.to,"My owner " + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
#=========================================
