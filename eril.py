...
cl = LINETCR.LINE()
cl.login(token="ErMNFnBH2pA1chziCBhc.QkPbNJ6gRL/mOMbKrjukZa.f0TPlFjQpCx1vAIFfoMZFO3RzyKbJ2Pe9RxGywZbTVc=")
cl.loginResult()
...
Bots = [mid]
admsa = "ua8aa419e3e86ae5f8ca2606444950acc"
admin = "ua8aa419e3e86ae5f8ca2606444950acc"
