...
cl = LINETCR.LINE()
cl.login(token="EqGi5Bb5wRHue0o2YWj2.DSpY4iJmGwDpcahMyyhEqG.0kTNFTQG2vP1XTS4hqsFxnkX04t6Eq4gMYCQO9hS6WQ=")
cl.loginResult()
...
admin = []
targets = []
Bots = [mid,"u76c3f2e088cc81674f0801e66181de42"]
creator = "u76c3f2e088cc81674f0801e66181de42"
admsa = "u76c3f2e088cc81674f0801e66181de42"
admin = "u76c3f2e088cc81674f0801e66181de42"
whitelist=[""]
wait = {
    'contact':False,
    'autoJoin':True,
                    ...
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                 ...
                                 #   'STKVER' : '1'}
                                  ...
                                  msg.contentType = 7    
                                  msg.text = None
                                  msg.contentMetadata = {'STKID': '17660266',
                                    'STKPKGID': '1475343',
                                    'STKVER': '1'}
                                    #'STKVER': '1'}
